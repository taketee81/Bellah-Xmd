...
const voltah = { Bellah, toIDR, Owner, reply,command,isCmd, example, mime, sleep, botNumber, nomore, prefix, reply, text, pickRandom, readmore,runtime,participants,ram,fetchJson,isBotAdmins,isAdmins,pushname,fetchJson,makeid,appname,Heroku,herokuapi}
